...
- Mention your environment (OS, Python version, package version, etc.).
...
4. Write tests covering your changes where appropriate.
5. Run tests to ensure everything passes.
6. Commit your changes with clear, descriptive commit messages.
7. Push your branch to your forked repository.
8. Open a pull request explaining your changes and reference any related issues.
...
If you're interested in becoming a core maintainer or have ideas for improving the governance of the project, please get in touch with the current maintainers.

---

Thank you for contributing to this project! Your efforts make this project better for everyone. 🎉
